...
// Commissioner. One of the 6 players holds admin powers (entering results,
// resetting drafts, managing drivers, etc.) — this id selects that player.
// Previously a separate 'admin' account existed; that flow was retired so
// the commissioner doesn't need a second login.
export const ADMIN_ID = 'p_justin';
