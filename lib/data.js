...
export const DEFAULT_SCHEDULE = [
  ...
  { wk: 13, track: 'Dover',           type: 'Short Oval',    len: 1.0,  laps: 250, date: 'May 17', time: '8:00 PM ET',  network: 'FS1',   raceName: 'NASCAR All-Star Race',            lastWinner: null, format: 'all-star',
    allStarPicks: {
      p_chad:   45, // Reddick
      p_trey:   11, // Hamlin
      p_soup:   11, // Hamlin
