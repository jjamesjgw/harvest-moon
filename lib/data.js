...
export const DEFAULT_SCHEDULE = [
  ...
  { wk: 13, track: 'Charlotte',       type: 'Intermediate',  len: 1.5,  laps: 400, date: 'May 24', time: '6:00 PM ET',  network: 'Prime', raceName: 'Coca-Cola 600',                   lastWinner: 'Ross Chastain' },
  { wk: 14, track: 'Nashville',       type: 'Intermediate',  len: 1.33, laps: 300, date: 'May 31', time: '3:30 PM ET',  network: 'Prime', raceName: 'Cracker Barrel 400',              lastWinner: 'Ryan Blaney' },
  { wk: 15, track: 'Michigan',        type: 'Intermediate',  len: 2.0,  laps: 200, date: 'Jun 07', time: '3:00 PM ET',  network: 'Prime', raceName: 'FireKeepers Casino 400',          lastWinner: 'Denny Hamlin' },
  { wk: 16, track: 'Pocono',          type: 'Intermediate',  len: 2.5,  laps: 160, date: 'Jun 14', time: '3:00 PM ET',  network: 'Prime', raceName: 'Great American Getaway 400',      lastWinner: 'Chase Briscoe' },
  { wk: 17, track: 'San Diego',       type: 'Street',        len: 3.0,  laps:  83, date: 'Jun 21', time: '3:30 PM ET',  network: 'Prime', raceName: 'Coronado Cup',                    lastWinner: null },
  { wk: 18, track: 'Sonoma',          type: 'Road Course',   len: 1.99, laps: 110, date: 'Jun 28', time: '3:30 PM ET',  network: 'TNT',   raceName: 'Toyota/Save Mart 350',            lastWinner: 'Shane van Gisbergen' },
  { wk: 19, track: 'Chicagoland',     type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Jul 05', time: '3:30 PM ET',  network: 'TNT',   raceName: 'Grant Park 165',                  lastWinner: null },
  { wk: 20, track: 'Atlanta (II)',    type: 'Superspeedway', len: 1.54, laps: 260, date: 'Jul 12', time: '7:00 PM ET',  network: 'TNT',   raceName: 'Quaker State 400',                lastWinner: 'Chase Elliott' },
  { wk: 21, track: 'N. Wilkesboro',   type: 'Short Oval',    len: 0.63, laps: 400, date: 'Jul 19', time: '3:30 PM ET',  network: 'TNT',   raceName: 'NASCAR North Wilkesboro 250',     lastWinner: null },
  { wk: 22, track: 'Indianapolis',    type: 'Intermediate',  len: 2.5,  laps: 160, date: 'Jul 26', time: '2:00 PM ET',  network: 'TNT',   raceName: 'Brickyard 400',                   lastWinner: 'Bubba Wallace' },
  { wk: 23, track: 'Iowa',            type: 'Short Oval',    len: 0.88, laps: 350, date: 'Aug 09', time: '3:30 PM ET',  network: 'USA',   raceName: 'Iowa Corn 350',                   lastWinner: 'William Byron' },
  { wk: 24, track: 'Richmond',        type: 'Short Oval',    len: 0.75, laps: 400, date: 'Aug 15', time: '7:00 PM ET',  network: 'USA',   raceName: 'Cook Out 400',                    lastWinner: 'Austin Dillon' },
  { wk: 25, track: 'New Hampshire',   type: 'Short Oval',    len: 1.06, laps: 301, date: 'Aug 23', time: '3:00 PM ET',  network: 'USA',   raceName: 'Mobil 1 301',                     lastWinner: 'Ryan Blaney' },
  { wk: 26, track: 'Daytona (II)',    type: 'Superspeedway', len: 2.5,  laps: 160, date: 'Aug 29', time: '7:30 PM ET',  network: 'NBC',   raceName: 'Coke Zero Sugar 400',             lastWinner: 'Ryan Blaney' },
  { wk: 27, track: 'Darlington (II)', type: 'Intermediate',  len: 1.37, laps: 367, date: 'Sep 06', time: '5:00 PM ET',  network: 'USA',   raceName: 'Cook Out Southern 500',           lastWinner: 'Chase Briscoe' },
  { wk: 28, track: 'Gateway',         type: 'Short Oval',    len: 1.25, laps: 240, date: 'Sep 13', time: '3:00 PM ET',  network: 'USA',   raceName: 'Enjoy Illinois 300',              lastWinner: 'Denny Hamlin' },
  { wk: 29, track: 'Bristol (II)',    type: 'Short Oval',    len: 0.53, laps: 500, date: 'Sep 19', time: '7:30 PM ET',  network: 'USA',   raceName: 'Bass Pro Shops Night Race',       lastWinner: 'Christopher Bell' },
  { wk: 30, track: 'Kansas (II)',     type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Sep 27', time: '3:00 PM ET',  network: 'USA',   raceName: 'Hollywood Casino 400',            lastWinner: 'Chase Elliott' },
  { wk: 31, track: 'Las Vegas (II)',  type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Oct 04', time: '5:30 PM ET',  network: 'USA',   raceName: 'South Point 400',                 lastWinner: 'Denny Hamlin' },
  { wk: 32, track: 'Charlotte (II)',  type: 'Intermediate',  len: 1.5,  laps: 400, date: 'Oct 11', time: '3:00 PM ET',  network: 'USA',   raceName: 'Bank of America 400',             lastWinner: null },
  { wk: 33, track: 'Phoenix (II)',    type: 'Short Oval',    len: 1.0,  laps: 312, date: 'Oct 18', time: '3:00 PM ET',  network: 'USA',   raceName: 'Phoenix Autumn 312',              lastWinner: 'Ryan Blaney' },
  { wk: 34, track: 'Talladega (II)',  type: 'Superspeedway', len: 2.66, laps: 188, date: 'Oct 25', time: '2:00 PM ET',  network: 'NBC',   raceName: 'YellaWood 500',                   lastWinner: 'Chase Briscoe' },
  { wk: 35, track: 'Martinsville(II)',type: 'Short Oval',    len: 0.53, laps: 500, date: 'Nov 01', time: '2:00 PM ET',  network: 'NBC',   raceName: 'Xfinity 500',                     lastWinner: 'William Byron' },
  { wk: 36, track: 'Homestead',       type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Nov 08', time: '3:00 PM ET',  network: 'NBC',   raceName: 'NASCAR Cup Series Championship',  lastWinner: 'Kyle Larson' },
];
...
export const DEFAULT_WEEK_CONFIG = {
  ...
  // Wk 18 — Sonoma (Jun 28): O'Reilly Series ran Jun 27 at Sonoma
  18: {
    allotments: { Cup: 4, OReilly: 1 },
  },
  // Wk 21 — N. Wilkesboro (Jul 19): Trucks ran Jul 18 at N. Wilkesboro
  21: {
    allotments: { Cup: 4, Truck: 1 },
  },
  // Wk 26 — Daytona II (Aug 29): O'Reilly Series ran Aug 28 at Daytona
  26: {
    allotments: { Cup: 4, OReilly: 1 },
  },
};
