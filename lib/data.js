...
export const DEFAULT_DRIVERS = [
  ...
  { num:  8, name:'K. Busch',     team:'RCR',         primary:'#FFCB05', secondary:'#D2232A', memorial:true }, // Cheddar's/Lucas — yellow/red. `memorial` triggers the in-memoriam treatment (corner band + partial desat) on every CarNum render.
  ...
  { num: 33, name:'A. Hill',      team:'RCR',         primary:'#FF7A00', secondary:'#1B2A6E' }, // Global Industrial — orange/navy
...
//   - wikiSlug (optional)         → explicit Wikipedia article slug for the results
//                                   ingest. REQUIRED when two races share a raceName
//                                   (e.g. the spring/summer "Cook Out 400") — the
//                                   name-derived slug would otherwise resolve to a
//                                   disambiguation page or the wrong race's article.
...
export const DEFAULT_SCHEDULE = [
  ...
  { wk: 7,  track: 'Martinsville',    type: 'Short Oval',    len: 0.53, laps: 400, date: 'Mar 29', time: '3:00 PM ET',  network: 'FS1',   raceName: 'Cook Out 400',  wikiSlug: '2026_Cook_Out_400_(Martinsville)',  lastWinner: 'Denny Hamlin' },
  ...
  { wk: 20, track: 'Chicagoland',     type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Jul 05', time: '6:00 PM ET',  network: 'TNT',   raceName: 'eero 400',                        lastWinner: null },
  ...
  { wk: 25, track: 'Richmond',        type: 'Short Oval',    len: 0.75, laps: 400, date: 'Aug 15', time: '7:00 PM ET',  network: 'USA',   raceName: 'Cook Out 400',  wikiSlug: '2026_Cook_Out_400_(Richmond)',  lastWinner: 'Austin Dillon' },
