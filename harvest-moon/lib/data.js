...
export const DEFAULT_SCHEDULE = [
  { wk: 1,  track: 'Daytona',         type: 'Superspeedway', len: 2.5,  laps: 200, date: 'Feb 15' },
  { wk: 2,  track: 'Atlanta',         type: 'Superspeedway', len: 1.54, laps: 260, date: 'Feb 22' },
  { wk: 3,  track: 'COTA',            type: 'Road Course',   len: 3.41, laps:  95, date: 'Mar 01' },
  { wk: 4,  track: 'Phoenix',         type: 'Short Oval',    len: 1.0,  laps: 312, date: 'Mar 08' },
  { wk: 5,  track: 'Las Vegas',       type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Mar 15' },
  { wk: 6,  track: 'Darlington',      type: 'Intermediate',  len: 1.37, laps: 293, date: 'Mar 22' },
  { wk: 7,  track: 'Martinsville',    type: 'Short Oval',    len: 0.53, laps: 400, date: 'Mar 29' },
  { wk: 8,  track: 'Bristol',         type: 'Short Oval',    len: 0.53, laps: 500, date: 'Apr 12' },
  { wk: 9,  track: 'Kansas',          type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Apr 19' },
  { wk: 10, track: 'Talladega',       type: 'Superspeedway', len: 2.66, laps: 188, date: 'Apr 26' },
  { wk: 11, track: 'Texas',           type: 'Intermediate',  len: 1.5,  laps: 267, date: 'May 03' },
  { wk: 12, track: 'Watkins Glen',    type: 'Road Course',   len: 2.45, laps:  90, date: 'May 10' },
  { wk: 13, track: 'Charlotte',       type: 'Intermediate',  len: 1.5,  laps: 400, date: 'May 24' },
  { wk: 14, track: 'Nashville',       type: 'Intermediate',  len: 1.33, laps: 300, date: 'May 31' },
  { wk: 15, track: 'Michigan',        type: 'Intermediate',  len: 2.0,  laps: 200, date: 'Jun 07' },
  { wk: 16, track: 'Pocono',          type: 'Intermediate',  len: 2.5,  laps: 160, date: 'Jun 14' },
  { wk: 17, track: 'San Diego',       type: 'Street',        len: 3.0,  laps:  83, date: 'Jun 21' },
  { wk: 18, track: 'Sonoma',          type: 'Road Course',   len: 1.99, laps: 110, date: 'Jun 28' },
  { wk: 19, track: 'Chicagoland',     type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Jul 05' },
  { wk: 20, track: 'Atlanta (II)',    type: 'Superspeedway', len: 1.54, laps: 260, date: 'Jul 12' },
  { wk: 21, track: 'N. Wilkesboro',   type: 'Short Oval',    len: 0.63, laps: 400, date: 'Jul 19' },
  { wk: 22, track: 'Indianapolis',    type: 'Intermediate',  len: 2.5,  laps: 160, date: 'Jul 26' },
  { wk: 23, track: 'Iowa',            type: 'Short Oval',    len: 0.88, laps: 350, date: 'Aug 09' },
  { wk: 24, track: 'Richmond',        type: 'Short Oval',    len: 0.75, laps: 400, date: 'Aug 15' },
  { wk: 25, track: 'New Hampshire',   type: 'Short Oval',    len: 1.06, laps: 301, date: 'Aug 23' },
  { wk: 26, track: 'Daytona (II)',    type: 'Superspeedway', len: 2.5,  laps: 160, date: 'Aug 29' },
  { wk: 27, track: 'Darlington (II)', type: 'Intermediate',  len: 1.37, laps: 367, date: 'Sep 06' },
  { wk: 28, track: 'Gateway',         type: 'Short Oval',    len: 1.25, laps: 240, date: 'Sep 13' },
  { wk: 29, track: 'Bristol (II)',    type: 'Short Oval',    len: 0.53, laps: 500, date: 'Sep 19' },
  { wk: 30, track: 'Kansas (II)',     type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Sep 27' },
  { wk: 31, track: 'Las Vegas (II)',  type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Oct 04' },
  { wk: 32, track: 'Charlotte (II)',  type: 'Intermediate',  len: 1.5,  laps: 400, date: 'Oct 11' },
  { wk: 33, track: 'Phoenix (II)',    type: 'Short Oval',    len: 1.0,  laps: 312, date: 'Oct 18' },
  { wk: 34, track: 'Talladega (II)',  type: 'Superspeedway', len: 2.66, laps: 188, date: 'Oct 25' },
  { wk: 35, track: 'Martinsville(II)',type: 'Short Oval',    len: 0.53, laps: 500, date: 'Nov 01' },
  { wk: 36, track: 'Homestead',       type: 'Intermediate',  len: 1.5,  laps: 267, date: 'Nov 08' },
];
