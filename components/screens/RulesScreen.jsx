  ...
  return <div style={{ paddingBottom:30 }}>
    ...
    <div style={{ padding:'8px 20px 20px' }}>
      ...
      <Rule term="Re-Draft Each Week">
        Rosters reset every week — fresh redraft for each race.
      </Rule>
      <Rule term="Scoring" last>
        Official NASCAR Cup Series points. Bonus picks count toward the same weekly total as Cup picks.
      </Rule>
    </div>
    ...
    <div style={{ padding:'8px 20px 20px' }}>
      ...
      <Rule term="How They're Drafted" last>
    ...
    <div style={{ padding:'8px 20px 20px' }}>
      ...
      <Rule term="Step 2 · Snake Draft" last>
